...
namespace DbKernel.Migrations
{
    ...
    [Migration("20190920213723_NovasClasses")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BsFat.Pessoa", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("BsFat.ClientesPF", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("ClientesPF");
                });
            ...
            modelBuilder.Entity("BsFat.ClientesPJ", b =>
                {
                    ...
                    b.Property<string>("TelComercial")
                        .HasColumnName("ClientesPJ_TelComercial")
                        .HasMaxLength(14);
                    ...
                    b.HasDiscriminator().HasValue("ClientesPJ");
                });
            ...
            modelBuilder.Entity("BsFat.Funcionarios", b =>
                {
                    ...
                    b.Property<string>("Cpf")
                        .HasColumnName("Funcionarios_Cpf");
                    ...
                    b.Property<DateTime?>("Nascimento")
                        .HasColumnName("Funcionarios_Nascimento");
                    ...
                    b.Property<string>("Rg")
                        .HasColumnName("Funcionarios_Rg")
                        .HasMaxLength(20);

                    b.Property<decimal>("Salario");

                    b.Property<string>("TelCelular")
                        .HasColumnName("Funcionarios_TelCelular")
                        .HasMaxLength(20);

                    b.Property<string>("TelResidencial")
                        .HasColumnName("Funcionarios_TelResidencial")
                        .HasMaxLength(20);
