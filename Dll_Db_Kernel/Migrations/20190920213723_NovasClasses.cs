		...
		protected override void Up(MigrationBuilder migrationBuilder)
		{
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					ClientesPJ_TelComercial = table.Column<string>(maxLength: 14, nullable: true),
					VeiculosId = table.Column<int>(nullable: true),
					Funcionarios_Rg = table.Column<string>(maxLength: 20, nullable: true),
					Funcionarios_Cpf = table.Column<string>(nullable: true),
					Funcionarios_Nascimento = table.Column<DateTime>(nullable: true),
					Funcionarios_TelResidencial = table.Column<string>(maxLength: 20, nullable: true),
					Funcionarios_TelCelular = table.Column<string>(maxLength: 20, nullable: true),
			...
			migrationBuilder.CreateTable(
				...
				columns: table => new
				{
					...
					IsAtivo = table.Column<bool>(nullable: false),
					ClientesPJId = table.Column<int>(nullable: true)
				},
				constraints: table =>
				{
