...
namespace Classes.Migrations
{
    ...
    [Migration("20190718053907_atualizacaoControlePatio")]
    partial class atualizacaoControlePatio
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Forms.Models.Locacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("Forms.Models.Pneus", b =>
                {
                    b.HasOne("Forms.Models.Veiculo")
                        .WithOne("Pneu")
                        .HasForeignKey("Forms.Models.Pneus", "VeiculoId")
            ...
            modelBuilder.Entity("Forms.Models.Sinistros", b =>
                {
                    b.HasOne("Forms.Models.Veiculo")
                        .WithOne("Sinistro")
                        .HasForeignKey("Forms.Models.Sinistros", "VeiculoId")
                        .OnDelete(DeleteBehavior.Cascade);
                });
