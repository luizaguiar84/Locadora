namespace Forms
{
	partial class FormCadastrarNovoVeiculo
	{
		...
		private void InitializeComponent()
		{
			...
			this.maskedDataAbastecimento = new System.Windows.Forms.MaskedTextBox();
			...
			this.txtQtdLitros = new System.Windows.Forms.TextBox();
			...
			this.maskedDataManutencao = new System.Windows.Forms.MaskedTextBox();
			...
			this.maskedDataSinistro = new System.Windows.Forms.MaskedTextBox();
			...
			this.tabAbastecimentos.Controls.Add(this.groupBox1);
			...
			this.dataGridView1.Size = new System.Drawing.Size(719, 120);
			...
			// Column3
			// 
			this.Column3.HeaderText = "Combustível";
			this.Column3.Name = "Column3";
			// 
			// Column4
			// 
			this.Column4.HeaderText = "Litros";
			...
			this.groupBox1.Controls.Add(this.maskedDataAbastecimento);
			this.groupBox1.Controls.Add(this.txtTotal);
			this.groupBox1.Controls.Add(this.label5);
			this.groupBox1.Controls.Add(this.lblTotal);
			this.groupBox1.Controls.Add(this.txtKmAbastecimento);
			this.groupBox1.Controls.Add(this.txtValorUnitAbastecimento);
			this.groupBox1.Controls.Add(this.label6);
			this.groupBox1.Controls.Add(this.label9);
			this.groupBox1.Controls.Add(this.comboCombustivel);
			this.groupBox1.Controls.Add(this.txtQtdLitros);
			...
			// 
			// maskedDataAbastecimento
			// 
			this.maskedDataAbastecimento.CutCopyMaskFormat = System.Windows.Forms.MaskFormat.IncludePromptAndLiterals;
			this.maskedDataAbastecimento.Location = new System.Drawing.Point(6, 40);
			this.maskedDataAbastecimento.Mask = "00/00/0000";
			this.maskedDataAbastecimento.Name = "maskedDataAbastecimento";
			this.maskedDataAbastecimento.Size = new System.Drawing.Size(90, 20);
			this.maskedDataAbastecimento.TabIndex = 2;
			this.maskedDataAbastecimento.TextMaskFormat = System.Windows.Forms.MaskFormat.IncludePromptAndLiterals;
			this.maskedDataAbastecimento.ValidatingType = typeof(System.DateTime);
			this.maskedDataAbastecimento.Leave += new System.EventHandler(this.maskedDataAbastecimento_Leave);
			// 
			// txtTotal
			// 
			...
			this.txtKmAbastecimento.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.txtKmAbastecimento_KeyPress);
			// 
			...
			// txtQtdLitros
			// 
			this.txtQtdLitros.Location = new System.Drawing.Point(359, 40);
			this.txtQtdLitros.MaxLength = 3;
			this.txtQtdLitros.Name = "txtQtdLitros";
			this.txtQtdLitros.Size = new System.Drawing.Size(100, 20);
			this.txtQtdLitros.TabIndex = 7;
			this.txtQtdLitros.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.txtQtdLitros_KeyPress);
			// 
			// label7
			// 
			...
			this.dataGridView2.Size = new System.Drawing.Size(719, 120);
			...
			// 
			this.dataGridViewTextBoxColumn2.HeaderText = "Km";
			...
			this.groupBox4.Controls.Add(this.maskedDataManutencao);
			this.groupBox4.Controls.Add(this.label12);
			this.groupBox4.Controls.Add(this.txtKmManutencao);
			this.groupBox4.Controls.Add(this.txtValorManutencao);
			...
			// 
			// maskedDataManutencao
			// 
			this.maskedDataManutencao.CutCopyMaskFormat = System.Windows.Forms.MaskFormat.IncludePromptAndLiterals;
			this.maskedDataManutencao.Location = new System.Drawing.Point(6, 40);
			this.maskedDataManutencao.Mask = "00/00/0000";
			this.maskedDataManutencao.Name = "maskedDataManutencao";
			this.maskedDataManutencao.Size = new System.Drawing.Size(90, 20);
			this.maskedDataManutencao.TabIndex = 2;
			this.maskedDataManutencao.TextMaskFormat = System.Windows.Forms.MaskFormat.IncludePromptAndLiterals;
			this.maskedDataManutencao.ValidatingType = typeof(System.DateTime);
			this.maskedDataManutencao.Leave += new System.EventHandler(this.maskedDataManutencao_Leave);
			// 
			// label12
			// 
			...
			this.dataGridView3.Size = new System.Drawing.Size(719, 120);
			...
			// 
			this.dataGridViewTextBoxColumn5.HeaderText = "Km";
			...
			this.groupBox9.Controls.Add(this.maskedDataSinistro);
			this.groupBox9.Controls.Add(this.label20);
			this.groupBox9.Controls.Add(this.txtKmSinistro);
			this.groupBox9.Controls.Add(this.txtValorSinistro);
			this.groupBox9.Controls.Add(this.label21);
			this.groupBox9.Controls.Add(this.label22);
			this.groupBox9.Controls.Add(this.label23);
			this.groupBox9.Location = new System.Drawing.Point(6, 10);
			this.groupBox9.Name = "groupBox9";
			this.groupBox9.Size = new System.Drawing.Size(740, 97);
			this.groupBox9.TabIndex = 17;
			this.groupBox9.TabStop = false;
			this.groupBox9.Text = "Lançamento de sinistros";
			// 
			// richTextBox2
			// 
			this.richTextBox2.Location = new System.Drawing.Point(219, 40);
			this.richTextBox2.Name = "richTextBox2";
			this.richTextBox2.Size = new System.Drawing.Size(361, 46);
			this.richTextBox2.TabIndex = 13;
			this.richTextBox2.Text = "";
			// 
			// button6
			// 
			this.button6.Location = new System.Drawing.Point(709, 40);
			...
			// maskedDataSinistro
			// 
			this.maskedDataSinistro.CutCopyMaskFormat = System.Windows.Forms.MaskFormat.IncludePromptAndLiterals;
			this.maskedDataSinistro.Location = new System.Drawing.Point(6, 40);
			this.maskedDataSinistro.Mask = "00/00/0000";
			this.maskedDataSinistro.Name = "maskedDataSinistro";
			this.maskedDataSinistro.Size = new System.Drawing.Size(90, 20);
			this.maskedDataSinistro.TabIndex = 2;
			this.maskedDataSinistro.TextMaskFormat = System.Windows.Forms.MaskFormat.IncludePromptAndLiterals;
			this.maskedDataSinistro.ValidatingType = typeof(System.DateTime);
			this.maskedDataSinistro.Leave += new System.EventHandler(this.maskedDataSinistro_Leave);
			// 
			// label20
			// 
			...
			this.tabObrigacoes.Controls.Add(this.maskedDataObrigacoes);
			...
			// txtValorObrigacoes
			// 
			this.txtValorObrigacoes.Location = new System.Drawing.Point(525, 31);
			...
			// 
			// maskedDataObrigacoes
			// 
			this.maskedDataObrigacoes.CutCopyMaskFormat = System.Windows.Forms.MaskFormat.IncludePromptAndLiterals;
			this.maskedDataObrigacoes.Location = new System.Drawing.Point(13, 32);
			this.maskedDataObrigacoes.Mask = "00/00/0000";
			this.maskedDataObrigacoes.Name = "maskedDataObrigacoes";
			this.maskedDataObrigacoes.Size = new System.Drawing.Size(83, 20);
			this.maskedDataObrigacoes.TabIndex = 1;
			this.maskedDataObrigacoes.TextMaskFormat = System.Windows.Forms.MaskFormat.IncludePromptAndLiterals;
			this.maskedDataObrigacoes.ValidatingType = typeof(System.DateTime);
			this.maskedDataObrigacoes.Leave += new System.EventHandler(this.maskedDataObrigacoes_Leave);
			// 
			// label24
			// 
		...
		private System.Windows.Forms.TextBox txtQtdLitros;
		private System.Windows.Forms.Label label8;
		private System.Windows.Forms.Label label7;
		private System.Windows.Forms.ComboBox comboCombustivel;
		private System.Windows.Forms.Label label6;
		private System.Windows.Forms.MaskedTextBox maskedDataAbastecimento;
		...
		private System.Windows.Forms.MaskedTextBox maskedDataManutencao;
		...
		private System.Windows.Forms.MaskedTextBox maskedDataSinistro;
		...
		private System.Windows.Forms.MaskedTextBox maskedDataObrigacoes;
