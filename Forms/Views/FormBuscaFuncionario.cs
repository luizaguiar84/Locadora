...
namespace FatCars.Desktop
{
	public partial class FormBuscaFuncionario : Form
	{
		...
		private void DataGridView1_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
		{
			...
			Funcionarios funcionario = new FuncionariosDao().GetFuncionarios().Single(x => x.Id == funcionarioId);
			Enderecos endereco = new EnderecosDao().DbGetEndereco(funcionario.EnderecoId);
			Cnhs cnh = new CnhsDao().DbGetCnh(funcionario.CnhId);
